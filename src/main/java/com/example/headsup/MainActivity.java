...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, IFragmentListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       //obtengo las categorias de los items
   ...
   //guardo todos las configuraciones del proyecto
  ...
  //inicializa el juego en la misma categoria
    public void restart()
    {
...
//inicializa el card
   ...
   //este metodo nos indica que tiempo ponerle
...
//tenemos las imagenes de las categorias
...
//metodo donde tenemos todos los items de los arrays
